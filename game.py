...
def over_screen(stype):
    ...
    while complete_running:
        ...
        UI.place_text('Счёт: ' + str(player.score), 350, 100)
...
if __name__ == '__main__':
    ...
    class UserInterface:
        def place_text(self, text, x, y, font_size=36):
    ...
    while running:
        ...
        UI.place_text('Здоровье: ' + str(player.health), 50, 20)
        UI.place_text('Счёт: ' + str(player.score), 50, 50)
        camera_move()
